...
export default function AddStudentModal({ isOpen, onClose, onSaved }) {
  ...
  async function handleSave() {
    if (!form.student_id || !form.first_name || !form.last_name) return
    setLoading(true)
    try {
      ...
      <div className="modal-body">
        ...
        <div className="form-grid" style={{ marginBottom: 24 }}>
          <FormGroup label="First Name" required>
            <FormInput value={form.first_name} onChange={(e) => set('first_name', e.target.value)} placeholder="e.g. Juan" />
          </FormGroup>
          <FormGroup label="Middle Name">
            <FormInput value={form.middle_name} onChange={(e) => set('middle_name', e.target.value)} placeholder="e.g. Dela" />
          </FormGroup>
          <FormGroup label="Last Name" required>
            <FormInput value={form.last_name} onChange={(e) => set('last_name', e.target.value)} placeholder="e.g. Cruz" />
          </FormGroup>
        ...
        <div className="form-grid" style={{ marginBottom: 24 }}>
          <FormGroup label="Email Address">
            <FormInput type="email" value={form.email} onChange={(e) => set('email', e.target.value)} placeholder="student@ctech.edu" />
          </FormGroup>
